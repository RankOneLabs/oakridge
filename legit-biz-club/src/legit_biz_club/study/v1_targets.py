...
_PROSE_SUBSTRATE_THESIS_BRIEF = Brief(
    target_spec=(
    ...
    success_criteria=[
        ...
        "to a software engineer with no prior context",
        "names the three coordination modes accurately (incremental, "
        "convergence, escalation) — does NOT invent others",
        "includes at least one concrete example (a project run, code "
        "fragment, or worked scenario)",
    ...
    constraints=[
        ...
        "no fictional code APIs — if you show code, show pseudocode "
        "or explicitly-marked illustrative examples",
    ],
)
...
def prose_substrate_thesis() -> TargetConfig:
    ...
    return prose_target(
        ...
        seed_content="",
        brief=_PROSE_SUBSTRATE_THESIS_BRIEF,
    )
...
_CODE_LEETCODE_LONGEST_SUBSTRING_BRIEF = Brief(
    target_spec=(
...
def code_leetcode_longest_substring() -> TargetConfig:
    ...
    return code_target(
        ...
        brief=_CODE_LEETCODE_LONGEST_SUBSTRING_BRIEF,
    )
