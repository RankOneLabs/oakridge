...
const artifact: ArtifactRevision = {
  ...
  output_name: "build_result", artifact_type: "dev.build_result", label: null, body: {}, version: 1, parent_artifact_id: null, created_at: "2026-08-14T12:00:00Z",
};
...
const fixture = (state: "awaiting_external" | "awaiting_downstream" = "awaiting_external") => {
  ...
  const dependencies: HandoffCompleteDependencies = {
    artifacts: { emit_revision: async () => artifact, find_by_id: async () => artifact, find_tip: async () => artifact, list_chain: async () => [artifact] },
