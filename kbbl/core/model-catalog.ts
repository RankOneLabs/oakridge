/**
 * Canonical model metadata catalog for lbc study runs.
 *
 * This is the single source of truth for model id → label, provider, and
 * display ordering used across lbc-dashboard (server + PWA). Adding a model
 * here is the one-edit operation; the generated mirror at
 * lbc-dashboard/src/generated/model_catalog.ts must be regenerated afterward:
 *
