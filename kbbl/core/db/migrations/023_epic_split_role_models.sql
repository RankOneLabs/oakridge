...
-- Each epic now stores a planner selection and a worker selection, while the
-- legacy agent_runtime column remains for compatibility during the cohort.
--
-- Backfill existing epics from the legacy single runtime:
